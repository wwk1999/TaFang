    ...
    public Dictionary<HeroType, List<List<int>>> 英雄技能树Dic = new Dictionary<HeroType, List<List<int>>>()
{
    ...
    public Dictionary<string, int> 符文Dic = new Dictionary<string, int>()
{
    {"击杀怪物获得神通能量_灵文",0},
    {"击杀怪物获得神通能量_仙文",0},
    {"击杀怪物获得神通能量_帝文",0},
    ...
    public Dictionary<string, int> 突破灵物Dic = new Dictionary<string, int>()
{
    ...
    public int Get符文数量(符文Type 符文Type, 符文品质Type 符文品质Type)
    {
        if (符文Type == 符文Type.None || 符文品质Type == 符文品质Type.None)
            return 0;

        string key = $"{符文Type}_{符文品质Type}";

        return 符文Dic.TryGetValue(key, out int count) ? count : 0;
    }
    
    public void Set符文数量(符文Type 符文Type, 符文品质Type 符文品质Type, int 数量)
    {
        if (符文Type == 符文Type.None || 符文品质Type == 符文品质Type.None)
            return;
