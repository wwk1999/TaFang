...
public class 三十三重天关卡item : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        {
            HeroWindowController.S.当前三十三重天Type = 主线关卡Type;
            ObserverModuleManager.S.SendEvent("三十三重天按钮点击",主线关卡Type);
        });
    ...
    public void SetItem()
    {
        ...
        if (suo)
        {
            ...
            suoText.text = (int)(主线关卡Type - 23) + ". ???";
        }
        else
        {
            关卡名.gameObject.SetActive(true);
            关卡名.text = (int)(主线关卡Type - 23) + ". "+LevelConfig.主线关卡NameDic[主线关卡Type];
            bg.image.sprite = ResourcesConfig.凌霄宝殿按钮;
            当前icon.gameObject.SetActive(false);
