...
public class 道纹GridImage : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerMoveHandler
{
    [Header("弹窗设置")]
    [Tooltip("弹窗预制体路径（相对于Resources文件夹）")]
    [SerializeField] private string popupPrefabPath = "Prefabs/Window/道纹信息弹窗";
    ...
    private void ShowPopup(Vector2 mousePosition)
    {
        ...
        道纹信息弹窗 弹窗 = currentPopup.GetComponent<道纹信息弹窗>();
        弹窗.道纹Type = 道纹grid.道纹Type;
        弹窗.QualityType = 道纹grid.QualityType;
        弹窗.SetItem();
        // 设置弹窗的位置
