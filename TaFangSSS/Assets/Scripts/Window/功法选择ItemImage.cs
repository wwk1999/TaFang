...
public class 功法选择ItemImage : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerMoveHandler
{
    [Header("弹窗设置")]
    [Tooltip("弹窗预制体路径（相对于Resources文件夹）")]
     private string popupPrefabPath = "Prefabs/Window/功法选择信息弹窗";
