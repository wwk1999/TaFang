...
public class BagGridImage : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerMoveHandler
{
    ...
    [SerializeField] private string popupPrefabPath = "Prefabs/Window/背包Grid信息弹窗";
    ...
    private void ShowPopup(Vector2 mousePosition)
    {
        ...
        背包Grid信息弹窗 弹窗 = currentPopup.GetComponent<背包Grid信息弹窗>();
        弹窗.PropType = BagGrid.propType;
        弹窗.QualityType = PropConfig.PropQualityDic[BagGrid.propType];
        弹窗.SetItem();
        // 设置弹窗的位置
