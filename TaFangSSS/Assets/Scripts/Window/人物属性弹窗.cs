...
public class 人物属性弹窗 : MonoBehaviour
{
    ...
    public void Show属性()
    {
        ...
        暴击率.text=(int)(属性.暴击率*100f)+"%";
        暴击伤害.text=(int)(属性config.Get英雄暴击伤害增幅()*100f)+"%";
        冷却缩减.text=(int)(属性.英雄冷却缩减*100f)+"%";
        战士.text=(int)(属性.战士增幅*100f-100)+"%";
        射手.text=(int)(属性.射手增幅*100f-100)+"%";
        法师.text=(int)(属性.法师增幅*100f-100)+"%";
        控制.text=(int)(属性.控制增幅*100f-100)+"%";
        物理.text=(int)(属性.物理伤害增幅*100f-100)+"%";
        火焰.text=(int)(属性.火焰伤害增幅*100f-100)+"%";
        冰霜.text=(int)(属性.冰霜伤害增幅*100f-100)+"%";
        雷电.text=(int)(属性.雷电伤害增幅*100f-100)+"%";
        黑暗.text=(int)(属性.黑暗伤害增幅*100f-100)+"%";
        普通怪.text=(int)(属性.普通怪伤害增幅*100f-100)+"%";
        精英怪.text=(int)(属性.精英怪伤害增幅*100f-100)+"%";
        首领怪.text=(int)(属性.首领伤害增幅*100f-100)+"%";
        无视抗性.text=(int)(属性.无视抗性*100f)+"%";
        伤害减免.text=(int)(属性.伤害减免*100f)+"%";
        最终伤害.text=(int)(属性.最终伤害增幅*100f-100)+"%";
