...
public class 体质Image : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerMoveHandler
{
     [Header("弹窗设置")]
    [Tooltip("弹窗预制体路径（相对于Resources文件夹）")]
    [SerializeField] private string popupPrefabPath = "Prefabs/Window/体质/体质信息弹窗";
    ...
    private void ShowPopup(Vector2 mousePosition)
    {
        ...
        体质信息弹窗 弹窗 = currentPopup.GetComponent<体质信息弹窗>();
        弹窗.体质Type = PlayerData.S.当前体质;
        弹窗.SetItem();
        // 设置弹窗的位置
