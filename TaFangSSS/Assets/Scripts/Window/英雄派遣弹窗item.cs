...
public class 英雄派遣弹窗item : MonoBehaviour
{
    ...
    public void 点击(object[] obj)
    {
        ...
        HeroWindowController.S.通天塔当前选择派遣HeroType = heroType;
    ...
    public void SetItem()
    {
        ...
        if (PlayerData.S.HeroDataDic[HeroType].派遣)
        {
            mask.SetActive(true);
            maskText.text = "派遣中";
        }else if (HeroConfig.HeroQualityDic[HeroType] < 需要品质 || PlayerData.S.HeroDataDic[HeroType].Level < 需要星级 + 1 ||
