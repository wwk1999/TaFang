...
public class 镶嵌孔itemImage : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerMoveHandler
{
   [Header("弹窗设置")]
    [Tooltip("弹窗预制体路径（相对于Resources文件夹）")]
    [SerializeField] private string popupPrefabPath = "Prefabs/Window/仙石信息弹窗";
    ...
    private void ShowPopup(Vector2 mousePosition)
    {
        ...
        if (镶嵌孔item.仙石.type == 仙石Type.None) return;
        // 加载弹窗预制体
        ...
        仙石信息弹窗 弹窗 = currentPopup.GetComponent<仙石信息弹窗>();
        弹窗.仙石 = 镶嵌孔item.仙石;
