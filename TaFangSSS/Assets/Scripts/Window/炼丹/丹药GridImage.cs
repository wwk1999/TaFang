...
public class 丹药GridImage : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerMoveHandler
{
     [Header("弹窗设置")]
    ...
    private void ShowPopup(Vector2 mousePosition)
    {
        ...
        弹窗.丹药Type = 丹药grid.丹药Type;
        弹窗.QualityType = 丹药grid.QualityType;
        弹窗.SetItem();
        // 设置弹窗的位置
