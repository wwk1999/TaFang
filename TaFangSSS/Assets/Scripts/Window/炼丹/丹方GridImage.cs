...
public class 丹方GridImage : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerMoveHandler
{
   [Header("弹窗设置")]
    [Tooltip("弹窗预制体路径（相对于Resources文件夹）")]
    [SerializeField] private string popupPrefabPath = "Prefabs/Window/炼丹界面/丹方信息弹窗";
    ...
    private void ShowPopup(Vector2 mousePosition)
    {
        ...
        丹方信息弹窗 弹窗 = currentPopup.GetComponent<丹方信息弹窗>();
        弹窗.丹药Type = 丹方grid.丹药Type;
        弹窗.QualityType = 丹方grid.QualityType;
        弹窗.SetItem();
        // 设置弹窗的位置
