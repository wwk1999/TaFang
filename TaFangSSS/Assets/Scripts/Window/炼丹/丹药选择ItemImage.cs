...
public class 丹药选择ItemImage : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerMoveHandler
{
   [Header("弹窗设置")]
    ...
    private void ShowPopup(Vector2 mousePosition)
    {
        ...
        弹窗.丹药Type = 丹药选择Item.丹药Type;
        弹窗.QualityType = 丹药选择Item.QualityType;
        弹窗.丹药显示Type = 丹药显示Type.战斗选择弹窗;
        弹窗.SetItem();
        // 设置弹窗的位置
