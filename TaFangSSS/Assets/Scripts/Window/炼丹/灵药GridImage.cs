...
public class 灵药GridImage : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerMoveHandler
{
    [Header("弹窗设置")]
    [Tooltip("弹窗预制体路径（相对于Resources文件夹）")]
    [SerializeField] private string popupPrefabPath = "Prefabs/Window/炼丹界面/灵药信息弹窗";
    ...
    private void ShowPopup(Vector2 mousePosition)
    {
        ...
        灵药信息弹窗 弹窗 = currentPopup.GetComponent<灵药信息弹窗>();
        弹窗.灵药Type = 灵药grid.灵药Type;
        弹窗.QualityType = 灵药grid.QualityType;
        弹窗.SetItem();
        // 设置弹窗的位置
