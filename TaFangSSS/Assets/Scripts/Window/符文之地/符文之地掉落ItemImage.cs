...
public class 符文之地掉落ItemImage : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerMoveHandler
{
     [Header("弹窗设置")]
    [Tooltip("弹窗预制体路径（相对于Resources文件夹）")]
    [SerializeField] private string popupPrefabPath = "Prefabs/Window/符文之地/符文之地道具信息弹窗";
    ...
    private void ShowPopup(Vector2 mousePosition)
    {
        ...
        符文之地道具信息弹窗 弹窗 = currentPopup.GetComponent<符文之地道具信息弹窗>();
        弹窗.propType = 符文之地掉落Item.PropType;
        弹窗.QualityType = 符文之地掉落Item.QualityType;
        弹窗.SetItem();
        // 设置弹窗的位置
