...
public class 世界树英雄派遣弹窗 : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        派遣Button.onClick.AddListener(() =>
        {
            ...
            PlayerData.S.HeroDataDic[HeroWindowController.S.世界树当前选择派遣HeroType].派遣 = true;
            PlayerData.S.世界树英雄派遣Dic[HeroWindowController.S.当前世界树层数][HeroWindowController.S.世界树英雄派遣Index] =
                HeroWindowController.S.世界树当前选择派遣HeroType;
    ...
    public void ShowList()
    {
        ...
        var 要求 = 世界树Config.世界树关卡Dic[HeroWindowController.S.当前世界树层数];
        foreach (var item in PlayerData.S.HeroDataDic)
        {
            if (item.Value.Level > 0)
            {
                var 派遣item = Instantiate(Resources.Load("Prefabs/Window/世界树英雄派遣弹窗item"), list.transform)
                    .GetComponent<世界树英雄派遣弹窗item>();
