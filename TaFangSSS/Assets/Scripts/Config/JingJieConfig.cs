...
public class JingJieConfig : MonoBehaviour
{
    public static Dictionary<JingJieType, List<long>> 突破材料Dic = new Dictionary<JingJieType, List<long>>()
    {
        ...
        { JingJieType.元婴, new List<long>() { 6000, 10000, 15000, 20000, 30000, 50000, 80000, 120000 } },
        { JingJieType.化神, new List<long>() { 10000, 15000, 20000, 30000, 50000, 80000, 120000, 180000 } },
        { JingJieType.合体, new List<long>() { 15000, 20000, 30000, 50000, 80000, 120000, 180000, 250000 } },
        { JingJieType.大乘, new List<long>() { 20000, 30000, 50000, 80000, 120000, 180000, 250000, 350000 } },
        { JingJieType.天仙, new List<long>() { 30000, 50000, 80000, 120000, 180000, 250000, 350000, 500000 } },
        { JingJieType.玄仙, new List<long>() { 50000, 80000, 120000, 180000, 250000, 350000, 500000, 800000 } },
        { JingJieType.金仙, new List<long>() { 80000, 120000, 180000, 250000, 350000, 500000, 800000, 1200000 } },
    ...
    public static Dictionary<JingJieType, float> 升级需要年数Dic = new Dictionary<JingJieType, float>()
    {
        ...
        { JingJieType.大乘,1000},
        { JingJieType.天仙,5000},
        { JingJieType.玄仙,20000},
        { JingJieType.金仙,100000},
