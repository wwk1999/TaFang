...
public class 符文Config
{
    ...
    public static Dictionary<符文Type, string> 符文效果Dic = new Dictionary<符文Type, string>()
    {
        ...
        { 符文Type.火同气连枝, "每上场一个火元素英雄增伤" },
        { 符文Type.冰同气连枝, "每上场一个冰元素英雄增伤" },
        { 符文Type.黑暗同气连枝, "每上场一个黑暗元素英雄增伤" },
        { 符文Type.雷电同气连枝, "每上场一个雷电元素英雄增伤" },
        { 符文Type.物理同气连枝, "每上场一个物理英雄增伤" },
        { 符文Type.战士同气连枝, "每上场一个战士英雄增伤" },
        { 符文Type.射手同气连枝, "每上场一个射手英雄增伤" },
        { 符文Type.控制同气连枝, "每上场一个控制英雄增伤" },
        { 符文Type.法师同气连枝, "每上场一个法师英雄增伤" },
        { 符文Type.辅助同气连枝, "每上场一个辅助英雄增伤" },
