...
public class LevelConfig : MonoBehaviour
{
    ...
    public static Dictionary<主线关卡Type, JingJieType> 主线关卡境界Dic = new Dictionary<主线关卡Type, JingJieType>()
    {
        ...
        { 主线关卡Type.登天路, JingJieType.大罗金仙 },
        { 主线关卡Type.欲界天, JingJieType.大罗金仙 },
        { 主线关卡Type.色界天, JingJieType.准圣 },
        { 主线关卡Type.无色天, JingJieType.准圣 },
        { 主线关卡Type.四梵天, JingJieType.准圣 },
        { 主线关卡Type.玉清境清微天, JingJieType.圣人 },
    ...
    public static Dictionary<主线关卡Type, SmallLevelInfo> LevelInfos = new Dictionary<主线关卡Type, SmallLevelInfo>()
{
    ...
    { 主线关卡Type.狮驼岭, new SmallLevelInfo() { NormalMonsterCount = 120, CreateNormalMonsterTime = 0.9f, EliteMonsterCount = 4 } },
    { 主线关卡Type.芭蕉洞, new SmallLevelInfo() { NormalMonsterCount = 130, CreateNormalMonsterTime = 0.9f, EliteMonsterCount = 4 } },
    ...
    { 主线关卡Type.瑶池仙境, new SmallLevelInfo() { NormalMonsterCount = 190, CreateNormalMonsterTime = 0.7f, EliteMonsterCount = 4 } },
    { 主线关卡Type.斩妖台, new SmallLevelInfo() { NormalMonsterCount = 200, CreateNormalMonsterTime = 0.7f, EliteMonsterCount = 4 } },
    { 主线关卡Type.御马监, new SmallLevelInfo() { NormalMonsterCount = 210, CreateNormalMonsterTime = 0.7f, EliteMonsterCount = 4 } },
    { 主线关卡Type.蟠桃园, new SmallLevelInfo() { NormalMonsterCount = 220, CreateNormalMonsterTime = 0.6f, EliteMonsterCount = 4 } },
    { 主线关卡Type.兜率宫, new SmallLevelInfo() { NormalMonsterCount = 230, CreateNormalMonsterTime = 0.6f, EliteMonsterCount = 4 } },
    { 主线关卡Type.紫微宫, new SmallLevelInfo() { NormalMonsterCount = 240, CreateNormalMonsterTime = 0.6f, EliteMonsterCount = 4 } },
    { 主线关卡Type.昊天殿, new SmallLevelInfo() { NormalMonsterCount = 250, CreateNormalMonsterTime = 0.6f, EliteMonsterCount = 4 } },

    { 主线关卡Type.登天路, new SmallLevelInfo() { NormalMonsterCount = 300, CreateNormalMonsterTime = 0.4f, EliteMonsterCount = 4 } },
    { 主线关卡Type.欲界天, new SmallLevelInfo() { NormalMonsterCount = 300, CreateNormalMonsterTime = 0.4f, EliteMonsterCount = 4 } },
    { 主线关卡Type.色界天, new SmallLevelInfo() { NormalMonsterCount = 300, CreateNormalMonsterTime = 0.4f, EliteMonsterCount = 4 } },
    { 主线关卡Type.无色天, new SmallLevelInfo() { NormalMonsterCount = 300, CreateNormalMonsterTime = 0.4f, EliteMonsterCount = 4 } },
    { 主线关卡Type.四梵天, new SmallLevelInfo() { NormalMonsterCount = 300, CreateNormalMonsterTime = 0.4f, EliteMonsterCount = 4 } },
    { 主线关卡Type.上清境禹余天, new SmallLevelInfo() { NormalMonsterCount = 300, CreateNormalMonsterTime = 0.4f, EliteMonsterCount = 4 } },
    { 主线关卡Type.玉清境清微天, new SmallLevelInfo() { NormalMonsterCount = 300, CreateNormalMonsterTime = 0.4f, EliteMonsterCount = 4 } },
    { 主线关卡Type.太清境大赤天, new SmallLevelInfo() { NormalMonsterCount = 300, CreateNormalMonsterTime = 0.4f, EliteMonsterCount = 4 } },
    { 主线关卡Type.大罗天, new SmallLevelInfo() { NormalMonsterCount = 300, CreateNormalMonsterTime = 0.4f, EliteMonsterCount = 4 } },
    { 主线关卡Type.混沌虚空, new SmallLevelInfo() { NormalMonsterCount = 300, CreateNormalMonsterTime = 0.4f, EliteMonsterCount = 4 } },
        ...
        new Dictionary<主线关卡Type, HashSet<LevelDiaoLuo>>()
        {
            ...
            },
            {
                ...
                new HashSet<LevelDiaoLuo>()
                {
                    ...
                    new LevelDiaoLuo() { maxCount = 3, minCount = 2, PropType = PropType.高级招募卷 },
